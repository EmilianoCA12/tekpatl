...
import AdminLoginPanel from "../AdminLoginPanel/AdminLoginPanel";
...
export default function Header() {
  ...
  return (
    <nav className={styles.headerContainer}>
      ...
      <AdminLoginPanel isOpen={loginOpen} onClose={() => setLoginOpen(false)}></AdminLoginPanel>
